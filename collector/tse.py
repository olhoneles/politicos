...
class TSE(object):
    ...
    def _format_sigla_ue(self, data):
        sigla_ue = data['sigla_ue']
        zeros = '0' * (5 - len(data['sigla_ue']))
        data['sigla_ue'] = f'{zeros}{sigla_ue}'
    ...
    def _format_politician_image(self, data):
        ...
        if election_id:
            politician_id = data['sequencial_candidato']
            uf = data['sigla_uf']
            url = f'{TSE_URL}/{data["ano_eleicao"]}'
            electoral_card = data['num_titulo_eleitoral_candidato']
            if data['ano_eleicao'] in [2004, 2008, 2012]:
                foto_url = f'{url}/{uf}/{sigla_ue}/{election_id}'
                ...
                foto_url = f'{url}/{uf}/{sigla_ue}/2/{politician_id}'
                foto_url = f'{foto_url}/{electoral_card}.jpg'
            elif data['ano_eleicao'] == 2018:
                foto_url = f'{url}/BR/{uf}/{election_id}/{politician_id}'
                foto_url = f'{foto_url}/foto_{electoral_card}.jpg'
            else:
                foto_url = None
