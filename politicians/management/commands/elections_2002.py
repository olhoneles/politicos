...
class Politicos2002(Politicos):

    @classmethod
    def get_picture(cls, politician_id, state_siglum):
        domain = 'http://www.tse.jus.br/sadEleicao2002/divulgacaoDeCandidatos'
...
class Command(PoliticosCommand):
    ...
    def handle(self, *args, **options):
        Politicos2002.set_options(*args, **options)
        self.process_tse_data_by_year(Politicos2002, 2002)
